...
impl<'data> RawPacket<'data> {
    ...
    pub fn head(&self) -> crate::packet_head::PacketHead {
        use crate::Protobuf;

        let head_len = BE::read_u16(&self.0[4..6]) as usize;
        crate::packet_head::PacketHead::decode(&self.0[10..][..head_len]).unwrap_or_default()
    }
...
pub fn make_raw_packet(cmd_id: u16, head: crate::packet_head::PacketHead, body: &[u8]) -> Box<[u8]> {
    use crate::Protobuf;
